...
//// Begin SDL time emulation

// These functions mostly emulate SDL_GetTicks64(), because this library doesn't
// use SDL, but timing data needs to be compatible with SDL-supplied data in moonlight-qt.
